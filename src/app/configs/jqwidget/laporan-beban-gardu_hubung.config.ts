import { BEBAN_PERJAM_JQWIDGET, DATETIME_JQWidget, GARDU_INDUK_JQWidget, LOADfAKTOR_JQWidget, MONTH_YEAR_JQWidget, MORE_BEBAN_MULTI_COLUMN_JQWidget, NO_JQWidget, GH_JQWidget, ULP_JQWidget, UP3_JQWidget, YEAR_JQWidget } from "./_more-jqwidget.column.config"
...
export const BEBAN_GH_PERJAM_COLUMN_JQWIDGET = () => {
    return {
        columns: [
            ...NO_JQWidget(),
            ...DATETIME_JQWidget(),
...
export const BEBAN_GH_HARIAN_COLUMN_JQWIDGET = () => {
    return {
        columns: [
            ...NO_JQWidget(),
            ...DATETIME_JQWidget(),
...
//     }
// }
export const BEBAN_GH_BULAN_COLUMN_JQWIDGET = () => {
    return {
        columns: [
            ...NO_JQWidget(),
            ...MONTH_YEAR_JQWidget(),
...
export const BEBAN_GH_TAHUN_COLUMN_JQWIDGET = () => {
    return {
        columns: [
            ...NO_JQWidget(),
            ...YEAR_JQWidget(),
