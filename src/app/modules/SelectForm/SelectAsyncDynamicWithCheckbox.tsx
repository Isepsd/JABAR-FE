        ...
        render={({ field: { onChange, value, ref } }) => (
         ...
         {isMulti ? (
            <Select
              ...
              ref={ref}
              value={value ? selectOptions.filter((opt: CheckboxOptionType) => value.includes(opt.value)) : []}
              ...
              options={selectOptions || []} // Pastikan options tersedia atau kosongkan array jika null/undefined
              styles={styles}
              isLoading={loading}
            ...
            <AsyncSelect
              placeholder={placeholder}
              ref={ref}
              value={selectOptions ? selectOptions.find((opt: CheckboxOptionType) => opt.value === value) : null}
              onChange={(selectedOption: OptionTypeBase | null) =>
                onChange(selectedOption ? (selectedOption as CheckboxOptionType).value : null)
              }
              classNamePrefix={`${get(errors, fieldName) ? 'is-invalid' : ''}`}
