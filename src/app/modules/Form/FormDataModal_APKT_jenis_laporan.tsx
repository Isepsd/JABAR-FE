...
function FormDataModal_APKT_jenis_laporan({
  modal = false,
  ...
  const upsertData = async (params: any) => {
    ...
    // const ID = params.id_apkt_trans_jar;
    const ID = dataSelected.current.id_apkt_trans_jar;
    if (ID) {
...
export default FormDataModal_APKT_jenis_laporan;
