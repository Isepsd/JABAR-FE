...
export default function Filter({ isTrafo = false,
  isGH = false,
  iskantor = false,
  isZone = false,
  isTrafoGD = false,
  ...
  return (
    ...
    {(optionCurrentUser?.level == "PUSAT" ||
              ...
              optionCurrentUser?.level == "UP2D" ||
              optionCurrentUser?.level == "UP3" ||
              optionCurrentUser?.level == "ULP") && iskantor && (
              <Col md={3}>
                <Form.Group className='mb-3'>
                  ...
                  <SelectAsyncDynamic
                    ...
                    queryParams={{ 
                      // id_ref_jenis_lokasi: `${JENIS_LOKASI().up3}`, sort_by: "nama_lokasi" 
                     id_ref_jenis_lokasi_in: `${JENIS_LOKASI().pusat},${JENIS_LOKASI().regional},${JENIS_LOKASI().uiw},${JENIS_LOKASI().up3},${JENIS_LOKASI().ulp}, ${JENIS_LOKASI().up2d}, ${JENIS_LOKASI().up3b}, ${JENIS_LOKASI().up2b}, ${JENIS_LOKASI().upt}, ${JENIS_LOKASI().ultg}`,
            ...
            {isGarduDistribusi &&  
              <Col md={3}>
             <Form.Group className='mb-3'>
                  <Form.Label>Gardu Distribusi<RequiredInfo /></Form.Label>
                  <SelectAsyncDynamic
                    required={true}
            ...
            {isTrafoGD &&  
              <Col md={3}>
             <Form.Group className='mb-3'>
                  <Form.Label>Trafo GD<RequiredInfo /></Form.Label>
                  <SelectAsyncDynamic
                    required={true}
                    {...selectTrafoGD}
                    isClearable={true}
            ...
            {isSegment &&  
              <Col md={3}>
             <Form.Group className='mb-3'>
                  <Form.Label>Segment<RequiredInfo /></Form.Label>
                  <SelectAsyncDynamic
                    required={true}
                    {...selectSegment}
                    isClearable={true}
