...
const TableDataJqxGridNew: React.FC<ITableDataJqxGridNew> = React.memo(
  ({
    ...
    const handleOnCellendedit = (item: any) => {
      const { args } = item;
      console.log("handleOnCellendedit");
        ...
        const buttonsContainer = (
          ...
          >
            ...
            {updatebtnJenisLap && (
              ...
              >
                {" "}
                <i className="fa-solid fa-edit"></i> Update Jenis Laporan{" "}
              </JqxButton>
            )}
            {updatebtnNoApkt && (
              <JqxButton
              ...
              >
                {" "}
                <i className="fa-solid fa-edit"></i> Update No APKT{" "}
              </JqxButton>
            )}
            {updatebtnStatus && (
              <JqxButton
            ...
            {uploadbtn && (
              ...
              >
                {" "}
                <i className="fa-solid fa-upload"></i> Upload from Excel{" "}
              </JqxButton>
            )}
            {deletebtn && (
              <JqxButton
