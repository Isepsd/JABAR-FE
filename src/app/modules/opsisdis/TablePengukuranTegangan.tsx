...
function TablePengukuranTegangan({
  roleActions,
  pathService,
  callBackCount,
  label,
...
Props) {
  ...
  const getAllData = async () => {
    ...
    try {
      const params = {
        ...
        sort_by: "id_parent_lokasi,no_urut_cell",
      };
  ...
  const getAllDataExport = async () => {
    ...
    const params = {
      ...
      ...filter,
      ...customParams,
      sort_by: "nama_parent_lokasi,nama_lokasi,no_urut_cell",
    };
    // if (queryParams?.time) {
...
export default TablePengukuranTegangan;
