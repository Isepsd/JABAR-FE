...
Props) {
  ...
  const { activeFilters }: any = useSelector((state: any) => state.ui);
  ...
  const watchTrafoGI = useWatch({ control, name: "id_ref_lokasi_trafo_gi" });
  const watchGarduHubung = useWatch({ control, name: "id_ref_lokasi_gh" });
  const watchPenyulang = useWatch({ control, name: "id_ref_lokasi_penyulang" });
  const watchZone = useWatch({ control, name: "id_ref_lokasi_zone" });
  const watchSection = useWatch({ control, name: "id_ref_lokasi_section" });
  ...
  const satuan = watch("satuan"); // Memantau perubahan pada nilai 'satuan'
  const satuan2 = watch("satuan2"); // Memantau perubahan pada nilai 'satuan'
  const satuan3 = watch("satuan3"); // Memantau perubahan pada nilai 'satuan'

  // const getFieldNameParent = () => {
  //   if (watchGarduInduk) {
  //     return 'id_gardu_induk';
  //   }
  //   if (watchTrafoGI) {
  //     return 'id_trafo_gi';
  //   }
  //   if (watchGarduHubung) {
  //     return 'id_gardu_hubung';
  //   }
  //   return '';
  // };
  ...
  useEffect(() => {
    ...
    if (activeFilters?.filters?.id_penyulang) {
      setValue("id_ref_lokasi_penyulang", activeFilters?.filters?.id_penyulang);
    }
    if (activeFilters?.filters?.id_gardu_hubung) {
      setValue("id_ref_lokasi_gh", activeFilters?.filters?.id_gardu_hubung);
    }
    if (
    ...
    if (
      !activeFilters?.filters?.id_gardu_induk &&
      activeFilters?.filters?.id_ref_lokasi_gh
    ) {
    ...
    if (
      !activeFilters?.filters?.id_gardu_induk &&
      activeFilters?.filters?.id_ref_lokasi_keypoint
    ) {
      setValue(
        "id_ref_lokasi_keypoint",
        activeFilters?.filters?.id_ref_lokasi_keypoint
      );
    }
        ...
        <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
          <Row>
              ...
              <>
                <Col md={6} className="mb-3">
                  <Form.Group>
                    <Form.Label>Range Tanggal</Form.Label>
                    <InputGroup>
                      <FormControl {...register("day_after")} type="date" />
                      <InputGroup.Text>
                        <i className="fa-solid fa-arrow-right"></i>
                      </InputGroup.Text>
                      <FormControl
              ...
              <>
                <Col md={4} className="mb-3">
                  <Form.Group>
                    ...
                    <InputGroup>
                      <FormControl {...register("year_after")} type="year" />

                      <InputGroup.Text>
                        <i className="fa-solid fa-arrow-right"></i>
                      </InputGroup.Text>
                      <FormControl {...register("year_before")} type="year" />
                    </InputGroup>
                  </Form.Group>
                </Col>
              </>
            ...
            {isSatuan3 && (
              <Col md={5}>
                <Form.Group className="mb-3">
                  <Form.Label>GI/Trafo GI/Zone/Section/Penyulang/GH</Form.Label>
                  <Controller
                    control={control}
                    defaultValue={""}
                    name="satuan3"
                    ...
                    render={({ field: { onChange, value, ref } }) => (
                      <Select
                        ...
                        classNamePrefix={`${errors.ufr ? "is-invalid" : ""}`}
                        inputRef={ref}
                        value={optionSatuan3?.filter(
                          (c: any) => c.value == value
                        )}
                        onChange={(val: any) => onChange(val?.value)}
                        options={optionSatuan3}
                        isClearable={true}
                      />
                    )}
                  />
            ...
            {(optionCurrentUser?.level == "PUSAT" ||
              ...
              optionCurrentUser?.level == "UP3" ||
              optionCurrentUser?.level == "ULP") &&
              (satuan === "gi" || satuan2 === "gi" || satuan3 === "gi") &&
              isGarduInduk2 && (
                <Col md={3}>
                  <Form.Group className="mb-2">
                    <Form.Label>Gardu Induk</Form.Label>
            ...
            {(optionCurrentUser?.level == "PUSAT" ||
              ...
              optionCurrentUser?.level == "UP3" ||
              optionCurrentUser?.level == "ULP") &&
              isGarduIndukTrafoGHZoneSectionPenyulang && (
                <Col md={3}>
                  <Form.Group className="mb-2">
                    <Form.Label>
                      GI/Trafo GI/GH/Zone/Section/Penyulang
                    </Form.Label>
                    <SelectAsyncDynamic
                      fieldName="id_ref_lokasi_gi"
                      pathServiceName="master.jaringan.ref_lokasi"
            ...
            {(optionCurrentUser?.level == "PUSAT" ||
              ...
              optionCurrentUser?.level == "ULP") &&
              isTrafo2 &&
              (satuan2 === "trafo_gi" || satuan3 === "trafo_gi") && (
                <Col md={3}>
                  <Form.Group className="mb-2">
                    <Form.Label>Trafo GI</Form.Label>
                    <SelectAsyncDynamic
                      fieldName="id_ref_lokasi_trafo_gi"
                      pathServiceName="master.jaringan.ref_lokasi"
                      labelField="nama_lokasi"
                ...
                <Form.Group className='mb-3'>
                  ...
                  <SelectAsyncDynamic
                    ...
                    queryParams={{
                      ...
                      id_ref_jenis_lokasi: watchPemilik || watchPengelola
                      ? (JENIS_LOKASI() as any)["penyulang"]
                      : (JENIS_LOKASI() as any)["kosong"],
                      sort_by: "nama_lokasi" }}
                    // watchParent={watchGarduInduk}
            ...
            {(optionCurrentUser?.level == "PUSAT" ||
              ...
              optionCurrentUser?.level == "UP3" ||
              optionCurrentUser?.level == "ULP") &&
              (satuan === "penyulang" || satuan3 === "penyulang") &&
              isPenyulang2 && (
                <Col md={3}>
                  <Form.Group className="mb-2">
                    <Form.Label>Penyulang</Form.Label>
                ...
                <Form.Group className="mb-3">
                  ...
                  <SelectAsyncDynamic
                    ...
                    queryParams={{
                      ...
                      // id_ref_jenis_lokasi: JENIS_LOKASI().gardu_hubung,
                      id_ref_jenis_lokasi:
                        watchGarduInduk || watchPenyulang
                          ? (JENIS_LOKASI() as any)["gardu_hubung"]
                          : (JENIS_LOKASI() as any)["kosong"],
                      sort_by: "nama_lokasi",
                      fungsi_lokasi: "GH",
                    ...
                    watchParent={watchGarduInduk || watchPenyulang}
                  />
                </Form.Group>
              </Col>
            )}
              ...
              satuan3 === "section" && (
                <Col md={3}>
                  <Form.Group className="mb-2">
                    ...
                    <SelectAsyncDynamic
                      fieldName="id_ref_lokasi_section"
                      pathServiceName="master.jaringan.ref_lokasi"
                      labelField="nama_lokasi"
                      valueField="id_ref_lokasi"
                      placeholder="Pilih..."
                ...
                <Form.Group className="mb-3">
                  ...
                  <SelectAsyncDynamic
                    ...
                    queryParams={{
                      ...
                      sort_by: "nama_lokasi",
                      // id_gardu_induk: watchGarduInduk,
                      // id_trafo_gi: watchTrafoGI,
                      // id_zone: watchZone,
                      // id_section: watchSection,
                      // id_penyulang: watchPenyulang,
                      // id_gardu_hubung: watchGarduHubung,
                      id_gardu_induk:
                        satuan === "gi" || satuan2 === "gi" || satuan3 === "gi"
                          ? watchGarduInduk
                          : null,
                      ...
                      id_penyulang:
                        ...
                        satuan3 === "penyulang"
                          ...
                          : null,
                      id_gardu_hubung:
                        satuan === "gh" || satuan2 === "gh" || satuan3 === "gh"
                          ? watchGarduHubung
                          : null,
                      // fungsi_lokasi:"GH"
              ...
              <Col md={3}>
                <Form.Group className="mb-3">
                  ...
                  <SelectAsyncDynamic
                    ...
                    isClearable={true}
                    // fieldNameParent="id_gardu_induk"
                    // fieldNameParent={getFieldNameParent()}
                    // fieldNameParent="id_ref_lokasi"
                    errors={errors}
                    control={control}
                    watchParent={
                      watchGarduInduk || watchTrafoGI || watchGarduHubung
                    }
                    queryParams={{
                      // id_ref_jenis_lokasi: JENIS_LOKASI().keypoint,
                      // id_ref_jenis_lokasi: JENIS_LOKASI().gardu_hubung,
                      ...
                      sort_by: "nama_lokasi",
                      // id_gardu_induk:
                      //   watchGarduInduk || watchGarduHubung || watchTrafoGI,
                      // id_gardu_induk: watchGarduInduk,
                      // id_gardu_hubung: watchGarduHubung,
                      // id_trafo_gi: watchTrafoGI,
                      id_gardu_induk:
