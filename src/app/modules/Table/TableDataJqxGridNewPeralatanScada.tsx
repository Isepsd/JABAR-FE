...
interface ITableDataJqxGridNew {
  ...
  onFilterChange?: any; // event ketika Update ex: mumunculkan modal atau reedirect ke form page
...
const getAllDataExport = async (export_type: any) => {
  setLoading(true); // Set loading to true before starting export
  ...
  try {
    ...
    setLoading(false); // Set loading to false once export is finished or if there's an error
  }
};
