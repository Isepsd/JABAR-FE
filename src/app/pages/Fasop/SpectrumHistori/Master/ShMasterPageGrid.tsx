...
import { HIS_MASTER_COLUMNS_GRID } from '@app/configs/react-table/fasop/spectrum-history.column';
...
export default function ShMasterPageGrid() {
        ...
        {roleActions.view &&
          <div key="2">
            <SmartGridComponent
              ...
              dataFieldsColsConfig={HIS_MASTER_COLUMNS_GRID()}
              primaryKey={'id'}
