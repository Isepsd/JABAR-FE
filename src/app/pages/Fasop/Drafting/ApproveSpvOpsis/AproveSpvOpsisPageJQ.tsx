...
/** CONFIG */
import { SCADATEL_WO_APPROVE_OPSIS_GRID } from "@app/configs/react-table/fasop/scadatel-column-drafting";
...
import AproveSpvOpsisFormApproveJQ from './AproveSpvOpsisFormApproveJQ'
import AproveSpvOpsisDetailPageJQ from './AproveSpvOpsisDetailPageJQ'
...
import AproveSpvScadatelFormView from "./AproveSpvOpsisFormView"
...
const [filterValues] = useState<any>({
  ...
  return (
    <>
      <CardWidget title='SCADATEL - Drafting - Approve SPV Opsis'>
        <Row className='gx-1'>
          {renderBoxKomulatif}
        </Row>
      </CardWidget>
        ...
        <div style={{ margin: '20px' }}>
          <JqxTabs theme={"light"}>
            <ul style={{ marginLeft: 10 }} key="1">
              <li><i className="fa-solid fa-server"></i> Approve SPV Opsis</li>
            </ul>
            <div key="2">
              <TableDataJqxGridNewButton
                ...
                dataFieldsColsConfig={SCADATEL_WO_APPROVE_OPSIS_GRID()}
