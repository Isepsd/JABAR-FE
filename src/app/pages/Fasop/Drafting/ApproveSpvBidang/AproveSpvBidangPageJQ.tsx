...
/** CONFIG */
import { SCADATEL_WO_APPROVE_BIDANG_GRID } from "@app/configs/react-table/fasop/scadatel-column-drafting";
...
export default function AproveSpvBidangPageJQ() {
...
const [filterValues] = useState<any>({
  ...
  const handleRowSelected = (data: any) => {
    ...
    setdetailAlreadyApprove(dataSelected?.current.approve_spv_data);
  ...
  return (
    <>
      <CardWidget title='SCADATEL - Drafting - Approve SPV Bidang'>
        <Row className='gx-1'>
          {renderBoxKomulatif}
        </Row>
      </CardWidget>
        ...
        <div style={{ margin: '20px' }}>
          <JqxTabs theme={"light"}>
            <ul style={{ marginLeft: 10 }} key="1">
              <li><i className="fa-solid fa-server"></i> Approve SPV Bidang</li>
            </ul>
            <div key="2">
              <TableDataJqxGridNewButton
                ...
                dataFieldsColsConfig={SCADATEL_WO_APPROVE_BIDANG_GRID()}
