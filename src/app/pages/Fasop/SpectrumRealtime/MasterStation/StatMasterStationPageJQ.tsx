...
/** CONFIG */
import { SCADATEL_STATUS_MASTER_STATION_COLUMN_JQX } from '@app/configs/react-table/fasop/spectrum-realtime.column'
       ...
       <div style={{ marginTop: '20px' }}>
          <div id="tabs">
            <ul style={{ marginLeft: 10 }} key="1">
              <li><i className="fa-solid fa-server"></i> Master Station Status</li>
            </ul>
          <div key="2">
          <TableDataJqxGridNew
            ...
            dataFieldsColsConfig={SCADATEL_STATUS_MASTER_STATION_COLUMN_JQX()}
