...
export default function StatTelemeteringPageJQ() {
    ...
    <div style={{ marginTop: '20px' }}>
      <div id="tabs">
        <ul style={{ marginLeft: 10 }} key="1">
          <li><i className="fa-solid fa-server"></i> Telemetering Status</li>
        </ul>
        <div key="2">
          <TableDataJqxGridNew
            ...
            filterParams={{id_induk_pointtype: 15, ...filterValues }}
