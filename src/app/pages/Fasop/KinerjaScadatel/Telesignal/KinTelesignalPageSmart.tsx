...
import { SCADATEL_KINERJA_TELESIGNAL_BULAN_COLUMN_GRID } from '@app/configs/react-table/fasop/scadatel-column';
          ...
          {roleActions.create && roleActions.update && roleActions.delete &&
              <div key="2">
                 ...
                 path={API_PATH().fasop.kinerja.digital}
                      ...
                      dataFieldsColsConfig={SCADATEL_KINERJA_TELESIGNAL_BULAN_COLUMN_GRID()}
                      primaryKey={'id'}
