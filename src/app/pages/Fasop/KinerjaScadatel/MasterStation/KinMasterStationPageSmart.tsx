...
import { SCADATEL_KINERJA_TELEMETERING_BULAN_COLUMN_GRID } from '@app/configs/react-table/fasop/scadatel-column';
...
export default function MainComponent() {
    ...
    useEffect(() => {
        let roleAccess = ROLE_ACCESS("master-station");
        const roleAct = {
    ...
    useEffect(() => {
        ...
        setFilterParams({
            rekap_kinerja: 1,
        id_induk_pointtype: '3fc4d6b6-6faf-4089-a020-344d16ad4208',
              ...
              <div key="2">
                  <SmartGridComponent
                   path={API_PATH().fasop.realtime.digital}
                      ...
                      dataFieldsColsConfig={SCADATEL_KINERJA_TELEMETERING_BULAN_COLUMN_GRID()}
                      primaryKey={'id'}
