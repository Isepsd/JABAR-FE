...
import { SCADATEL_STATUS_TELEMETERING_30m_COLUMN_GRID } from '@app/configs/react-table/fasop/spectrum-realtime.column';
          ...
          {roleActions.create && roleActions.update && roleActions.delete &&
              <div key="2">
                  <SmartGridComponent
                      ...
                      dataFieldsColsConfig={SCADATEL_STATUS_TELEMETERING_30m_COLUMN_GRID()}
                      primaryKey={'id'}
