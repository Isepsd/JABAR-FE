...
const mappingBarChart = (data: any) => {
  ...
  data.forEach((item: any) => {
    ...
    cat.push(item.tgl_gangguan); // pastikan format nama_penyulang sesuai
  });
  return { res, cat };
};
...
export default function ChartNyobaPadamPenyulang({
      ...
      point: {
        events: {
          click: function (event: any) {
            const tgl_gangguan1 = event.point.category;
  ...
  return (
    <div className='px-4'>
      ...
      <h2 className='mb-4 text-center'>Jumlah Gangguan VS Non Gangguan Perbulan Dalam Gangguan</h2>
