...
export default function PbPenyulangCol3PhasePage() {
  const url = API_PATH().opsisdis.pengukuran_beban.penyulang_col;
  const urlCountNull = API_PATH().opsisdis.pengukuran_beban.penyulang_col_total;
  ...
  useEffect(() => {
    ...
    let roleAccess = ROLE_ACCESS("pengukuran-beban-penyulang-col-3phase")
    const roleAct = {
  ...
  useEffect(() => {
    let fields: any = PENGUKURAN_BEBAN_PENYULANG_COLUMN_3PHASE_JQWIDGET()
    setColumns(fields)
  }, [roleActions])
