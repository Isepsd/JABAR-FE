...
import { PENGUKURAN_BEBAN_GH_COLUMN_3PHASE_JQWIDGET } from "@app/configs/jqwidget/pengukuran-beban-penyulang.column.config";
import moment from "moment";

export default function PbGarduHubungColPage() {
  ...
  useEffect(() => {
    ...
    setLoading(false);
    let roleAccess = ROLE_ACCESS("gh-col");
    const roleAct = {
      ...
      {loading == false && (
        <div>
          ...
          <TablePengukuranBeban
            //TABLE DATA
            path={API_PATH().opsisdis.pengukuran_beban.gh_col}
            filterParams={{
              // jenis_layanan: "KTT",
              ...filterValues,
            }}
            dataFieldsColsConfig={PENGUKURAN_BEBAN_GH_COLUMN_3PHASE_JQWIDGET()}
            primaryKey={"id"}
