...
import Filter from "../Filter/FilterColTrafo";
...
import { PENGUKURAN_BEBAN_TRAFO_COLUMN_3PHASE_JQWIDGET } from "@app/configs/jqwidget/pengukuran-beban-penyulang.column.config";
import moment from "moment";

export default function PbTrafoGIColPage() {
        ...
        <div>
          ...
          >
            <Filter
              ...
              optionJenisLayanan="NON KTT"
            />
          </TableDataListActionNew>

          <TablePengukuranBeban
            //TABLE DATA
            path={API_PATH().opsisdis.pengukuran_beban.trafogi_col}
            filterParams={{
              jenis_layanan: "NON KTT",
              ...filterValues,
            }}
            dataFieldsColsConfig={PENGUKURAN_BEBAN_TRAFO_COLUMN_3PHASE_JQWIDGET()}
            primaryKey={"id"}
