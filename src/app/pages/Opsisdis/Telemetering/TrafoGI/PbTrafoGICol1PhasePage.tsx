...
export default function PbTrafoGICol1PhasePage() {
      ...
      {loading == false && (
        <div>
          ...
          <TablePengukuranBeban
            //TABLE DATA
            path={
              API_PATH().opsisdis.pengukuran_beban.trafo_gi_non_ktt_col_1phase
            }
            filterParams={{
              jenis_layanan: "NON KTT",
              ...filterValues,
            }}
            dataFieldsColsConfig={PENGUKURAN_BEBAN_TRAFO_COLUMN_1PHASE_JQWIDGET(
              roleActions
            )}
            primaryKey={"id"}
