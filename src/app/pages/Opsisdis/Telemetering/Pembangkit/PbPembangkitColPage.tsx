...
import Filter from "../Filter/FilterColPembangkit";
...
import { PENGUKURAN_BEBAN_PEMBANGKIT_COLUMN_3PHASE_JQWIDGET } from "@app/configs/jqwidget/pengukuran-beban-penyulang.column.config";
import moment from "moment";

export default function PbPembangkitColPage() {
  ...
  useEffect(() => {
    ...
    setLoading(false);
    let roleAccess = ROLE_ACCESS("pembangkit-col");
    const roleAct = {
      ...
      {loading == false && (
        <div>
          ...
          <TablePengukuranBeban
            //TABLE DATA
            path={API_PATH().opsisdis.pengukuran_beban.pembangkit_col}
            filterParams={{
              // jenis_layanan: "KTT",
              ...filterValues,
            }}
            dataFieldsColsConfig={PENGUKURAN_BEBAN_PEMBANGKIT_COLUMN_3PHASE_JQWIDGET()}
            primaryKey={"id"}
