...
import { BEBAN_KWH_HARIAN_HARIAN_COLUMN_JQWIDGET } from '@app/configs/jqwidget/laporan-beban-kwh-harian';
...
const tabOptions = [
  ...
  { label: 'Beban Harian', value: 'beban_harian', format: 'DD/MM/YYYY', pathService: API_PATH().opsisdis.laporan_beban.up2b.harian, column: KWH_HARIAN(), primaryKey: 'id' },
...
export default function LbtBebankWhHarianPage() {
            ...
            {activeFilters?.filters?.id_ref_lokasi_gi && (
              <Card.Body>
                ...
                {tabActive == "beban_harian" &&
                  <DynamicBebanAreaTable pathService={API_PATH().opsisdis.laporan_beban.up2b.harian} columnsConfig={BEBAN_KWH_HARIAN_HARIAN_COLUMN_JQWIDGET()} primaryKey={tabActiveConf.primaryKey} configParams={customFilter} tabActive={'beban_harian'} label="laporan beban up2b" />
                }
                {/* {tabActive == "puncak_bulanan" &&
                  <DynamicBebanAreaTable pathService={API_PATH().opsisdis.laporan_beban.up2b.bulanan} columnsConfig={BEBAN_PUNCAK_BULANAN_UP2B_COLUMN()} primaryKey={tabActiveConf.primaryKey} configParams={customFilter} tabActive={'puncak_bulanan'} label="laporan beban up2b" />
                }
