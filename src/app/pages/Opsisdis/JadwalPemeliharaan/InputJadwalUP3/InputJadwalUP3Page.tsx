...
function InputJadwal() {
  ...
  const handleRowSelected = (data: any) => {
    ...
    setDetails(dataSelected?.current?.id_trans_jadwal_har);
    setTrigger(dataSelected?.current?.id_trans_jadwal_har);
}
    ...
    <>
      ...
      <Col md={8}>
        ...
        <table>
          <tbody>
            <tr>
              <td className="bgputih">&nbsp;&nbsp;&nbsp;</td>
              <td>Belum Disetujui&nbsp;&nbsp;&nbsp;</td>
              <td className="bgkuning">&nbsp;&nbsp;&nbsp;</td>
              <td>Sudah diposting&nbsp;&nbsp;&nbsp;</td>
              <td className="bghijau">&nbsp;&nbsp;&nbsp;</td>
              <td>Sudah disetujui&nbsp;&nbsp;&nbsp;</td>
              <td className="bgmerah">&nbsp;&nbsp;&nbsp;</td>
              <td>Batal&nbsp;&nbsp;&nbsp;</td>
            </tr>
          </tbody>
        </table>
          ...
          <Col md={12} className='mb-4 position-static'>
            <Card className='card-widget position-static'>
              ...
              <Card.Body>
                ...
                filterParams={{ id_trans_jadwal_har: details ? details : null }} 
