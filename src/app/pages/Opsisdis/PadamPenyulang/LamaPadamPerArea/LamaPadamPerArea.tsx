...
import { LAMA_PADAM_PER_AREA_COLUMN_JQWidget } from '@app/configs/react-table/opsisdis/padam-penyulang/laporan-penyulang.column';
...
const tabOptions = [
  { label: 'Lama Padam Per Area', value: 'beban_perjam', format: 'DD/MM/YYYY HH:mm', pathService: API_PATH().opsisdis.padam_penyulang.lama_padam_area, column: LAMA_PADAM_PER_AREA_COLUMN(), primaryKey: 'id' },
...
// };
export default function LamaPadamPerAreaPage() {
  // export default function LamaPadamPerAreaPage({ optionCurrentUser }: Props) {
          ...
          <Card className='card-widget position-static'>
            <Card.Body>
              ...
              {Object.keys(queryParams).length > 0 && (
                <ChartlaporanBeban
                  tabActive={tabActive}
                  path={API_PATH().opsisdis.padam_penyulang.lama_padam_area}
            ...
            {Object.keys(queryParams).length > 0 && (
              <Card.Body>
                ...
                {tabActive == "beban_perjam" &&
                  <DynamicBebanAreaTable pathService={API_PATH().opsisdis.padam_penyulang.lama_padam_area} columnsConfig={LAMA_PADAM_PER_AREA_COLUMN_JQWidget()} primaryKey={tabActiveConf.primaryKey} tabActive={'beban_perjam'} label="laporan beban pembangkit" columnsGroupConfig={null}
                    filterParams={{
                      // id_pusat:
