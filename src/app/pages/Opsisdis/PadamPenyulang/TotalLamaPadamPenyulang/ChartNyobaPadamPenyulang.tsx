...
export default function ChartNyobaPadamPenyulang({
  ...
  //       events: {
  //         click: (event: any) => {
  //           // alert(`You clicked on ${event.point.category}: ${event.point.y} minutes`);
  //           console.log(`You clicked on ${event.point.category}: ${event.point.y} minutes`);
  //           const penyulangId = event.point.category;
      ...
      point: {
        events: {
          click: function (event: any) {
            const penyulangId = event.point.options.penyulang_id;
            // alert(`You clicked on ${event.point.category}: ${event.point.y} minutes and id = ${event.point.options.penyulang_id}`);
            // setSelectedData(event.point.category); // Menyimpan data yang di klik ke dalam state
            // setShowForm(true); // Menampilkan form dan table
            handleOpenModal(); // membuka modal
  ...
  return (
    <div className='px-4'>
      ...
      <h2 className='mb-4 text-center'>Total Lama Padam Penyulang (menit)</h2>
