...
import {
  TOTAL_LAMA_PADAM_PENYULANG_COLUMN
  // LOAD_SUBSISTEM_FAKTOR_BULANAN_COLUMN 
...
const tabOptions = [
  { label: 'Total Lama Padam Penyulang', value: 'beban_perjam', format: 'DD/MM/YYYY HH:mm', pathService: API_PATH().opsisdis.padam_penyulang.total_lama_padam_penyulang, column: TOTAL_LAMA_PADAM_PENYULANG_COLUMN(), primaryKey: 'id' },
...
// export default function TotalLamaPadamPenyulangPage({ optionCurrentUser }: Props) {
export default function TotalLamaPadamPenyulangPage() {
          ...
          <Card className='card-widget position-static'>
            <Card.Body>
              ...
              <div className='px-2 mt-2'>
                ...
                {/* <SubSistemFilter tabActive={tabActive} optionCurrentUser={currentUser} optionJenisLayanan={false} isRegional={true} isUID={true} isUP2D={true} configFilter={["id_pengelola"]} /> */}
            ...
            {Object.keys(queryParams).length > 0 && (
              <Card.Body>
                ...
                {tabActive == "beban_perjam" &&
                  <DynamicBebanAreaTable pathService={API_PATH().opsisdis.padam_penyulang.total_lama_padam_penyulang} columnsConfig={TOTAL_LAMA_PADAM_PENYULANG_COLUMN_JQWidget()} primaryKey={tabActiveConf.primaryKey} tabActive={'beban_perjam'} label="laporan beban pembangkit" columnsGroupConfig={null} filterParams={{
                    // id_pusat:
