...
import {
  PADAM_5_MENIT_COLUMN
  // LOAD_SUBSISTEM_FAKTOR_BULANAN_COLUMN 
} from '@app/configs/react-table/opsisdis/padam-penyulang/padam-penyulang';

import { PADAM_5_MENIT_COLUMN_JQWidget } from '@app/configs/react-table/opsisdis/padam-penyulang/laporan-penyulang.column';
...
const tabOptions = [
  { label: 'Padam 5 Menit', value: 'beban_perjam', format: 'DD/MM/YYYY HH:mm', pathService: API_PATH().opsisdis.padam_penyulang.padam_5_menit, column: PADAM_5_MENIT_COLUMN(), primaryKey: 'id' },
...
export default function Padam5MenitPage() {
  // export default function Padam5MenitPage({ optionCurrentUser }: Props) {
          ...
          <Card className='card-widget position-static'>
            <Card.Body>
              ...
              {Object.keys(queryParams).length > 0 && (
                ...
                <ChartlaporanBeban
                  tabActive={tabActive}
                  path={API_PATH().opsisdis.padam_penyulang.padam_5_menit}
            ...
            {(Object.keys(queryParams).length > 0) && (
              ...
              <Card.Body>
                ...
                {tabActive == "beban_perjam" &&
                  <DynamicBebanAreaTable pathService={API_PATH().opsisdis.padam_penyulang.padam_5_menit}
                    columnsConfig={PADAM_5_MENIT_COLUMN_JQWidget()} primaryKey={tabActiveConf.primaryKey} tabActive={'beban_perjam'} label="beban_uid"
                  // filterParams={{
                  //   id_pusat:
