...
/** CONFIG */
import { REGU_PETUGAS_COLUMN_JQX } from '@app/configs/react-table/master-data-adminksa.columns.config';
...
export default function ReguPetugasJQ() {
    ...
    const handleRespDataApi = (data: any) => {
        ...
        data?.forEach((item: any) => {
            dataTableValue.push({
                id_ref_regu_petugas:item?.id_ref_regu_petugas,
                number: item?.number,
                name: item?.name,
        ...
        <>
            ...
            <JqxTabs theme="light">
                <ul style={{ marginLeft: 10 }} key="1">
                    <li><i className="fa-solid fa-server"></i> Regu</li>
                ...
                <div key="2">
                    <TableDataJqxGridNew
                        ...
                        filterParams={{}}
                        dataFieldsColsConfig={REGU_PETUGAS_COLUMN_JQX()}
