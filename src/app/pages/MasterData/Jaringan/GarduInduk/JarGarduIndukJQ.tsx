...
/** CONFIG */
import { GARDU_INDUK_COLUMN_JQX, } from '@app/configs/react-table/master-jaringan.columns.config';
...
export default function JarGarduIndukJQ() {
      ...
      {roleActions.create && roleActions.update && roleActions.delete &&
        ...
        >
          <ul style={{ marginLeft: 10 }} key="1">
            <li><i className="fa-solid fa-server"></i> Gardu Induk</li>
          ...
          <div key="2">
            <TableDataJqxGridNew
              ...
              dataFieldsColsConfig={GARDU_INDUK_COLUMN_JQX()}
