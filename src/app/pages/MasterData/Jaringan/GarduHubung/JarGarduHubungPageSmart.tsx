...
import { GARDU_HUBUNG_COLUMNS_GRID } from '@app/configs/react-table/master-jaringan.columns.config';
    ...
    const handleRespDataApi = (data: any) => {
        return data.results.map((result: any) => ({
          number: result.number,
                ...
                status: result?.status_listrik === 1 ? <input type="checkBox" /> : null,
        }));
      };
         ...
         <MasterDataFilter optionCurrentUser={currentUser} onFilterChange={handleFilterChange}  isGarduInduk={true} isGH={true}    />
            ...
            {roleActions.create && roleActions.update && roleActions.delete &&
                    ...
                    <SmartGridComponent
                        ...
                        dataFieldsColsConfig={GARDU_HUBUNG_COLUMNS_GRID()}
