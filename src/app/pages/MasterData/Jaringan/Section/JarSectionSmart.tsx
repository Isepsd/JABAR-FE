...
import { SECTION_COLUMN_GRID, } from '@app/configs/react-table/master-jaringan.columns.config';
            ...
            {roleActions.create && roleActions.update && roleActions.delete &&
                    <div key="2">
                        <SmartGridComponent
                            ...
                            filterParams={{ id_ref_jenis_lokasi: JENIS_LOKASI().section, fungsi_lokasi:'SECTION', sort_by: '-id_ref_lokasi' }}
                            dataFieldsColsConfig={SECTION_COLUMN_GRID()}
