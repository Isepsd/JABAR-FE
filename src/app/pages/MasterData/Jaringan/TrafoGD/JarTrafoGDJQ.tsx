...
/** CONFIG */
import { TRAFOGD_COLUMN_JQX, } from '@app/configs/react-table/master-jaringan.columns.config';
...
export default function JarTrafoGDJQ() {
  ...
  useEffect(() => {
    let roleAccess = ROLE_ACCESS("trafo-gd");
    const roleAct = {
  ...
  return (
    <>
      {/* <div className='px-2 mt-2'>
        <MasterDataFilter optionCurrentUser={currentUser} onFilterChange={handleFilterChange} isTrafoGD={true} />
      </div> */}
      {roleActions.create && roleActions.update && roleActions.delete &&
        <JqxTabs theme="light">
          <ul style={{ marginLeft: 10 }} key="1">
            <li><i className="fa-solid fa-server"></i> Trafo GD</li>
          ...
          <div key="2">
            <TableDataJqxGridNew
              ...
              filterParams={{ id_ref_jenis_lokasi: JENIS_LOKASI().trafo_gd }}
              dataFieldsColsConfig={TRAFOGD_COLUMN_JQX()}
