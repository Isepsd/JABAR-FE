...
import { TRAFOGD_COLUMN_GRID, } from '@app/configs/react-table/master-jaringan.columns.config';
    ...
    const handleRespDataApi = (data: any) => {
        return data.results.map((result: any) => ({
          id_ref_lokasi:result?.id_ref_lokasi,
            ...
            phase: result?.phase,
            status_listrik: result?.status_listrik
        }));
    };
           ...
           <div className='px-2 mt-2'>
            ...
            {roleActions.create && roleActions.update && roleActions.delete &&
                        <SmartGridComponent
                            ...
                            filterParams={{ id_ref_jenis_lokasi: JENIS_LOKASI().trafo_gd,...filterValues }}
                            dataFieldsColsConfig={TRAFOGD_COLUMN_GRID()}
