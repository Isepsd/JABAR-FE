...
import {
  // IJenisMutasi,
  JenisMutasiField,
} from "@app/interface/master-data/eam-jenis-mutasi.interface";
...
export default function JenisMutasiFormPage() {
  ...
  return (
    <>
      <FormData
        ...
        fields={JenisMutasiField}
        path={API_PATH().master.eam.eam_ref_jenis_mutasi}
        onLoading={setLoading}
      >
        <Col md="6" xs="12">
          <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
            <Form.Group className="mb-3">
              <Form.Label>Nama Jenis Mutasi</Form.Label>
