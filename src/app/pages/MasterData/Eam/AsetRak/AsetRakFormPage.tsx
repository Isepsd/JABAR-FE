...
import {
  // IAsetRak,
  AsetRakField,
} from "@app/interface/master-data/eam-aset-rak.interface";
...
export default function AsetRakFormPage() {
  ...
  return (
    <>
      <FormData
        ...
        fields={AsetRakField}
        path={API_PATH().master.eam.eam_ref_aset_rak}
        onLoading={setLoading}
      >
        <Col md="6" xs="12">
          <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
            <Form.Group className="mb-3">
              <Form.Label>Nama Rak</Form.Label>
