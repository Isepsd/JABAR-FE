...
import {
  // IAsetManufaktur,
  AsetManufakturField,
} from "@app/interface/master-data/eam-aset-manufaktur.interface";
...
export default function AsetManufakturFormPage() {
  ...
  return (
    <>
      <FormData
        ...
        fields={AsetManufakturField}
        path={API_PATH().master.eam.eam_ref_aset_manufaktur}
        onLoading={setLoading}
      >
        <Col md="6" xs="12">
          <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
            <Form.Group className="mb-3">
              <Form.Label>Nama Manufaktur</Form.Label>
