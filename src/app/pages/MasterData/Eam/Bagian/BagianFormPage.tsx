...
import {
  // IBagian,
  BagianField,
} from "@app/interface/master-data/eam-bagian.interface";
...
export default function BagianFormPage() {
  ...
  return (
    <>
      <FormData
        ...
        fields={BagianField}
        path={API_PATH().master.eam.eam_ref_bagian}
        onLoading={setLoading}
      >
        <Col md="6" xs="12">
          <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
            <Form.Group className="mb-3">
              <Form.Label>Nama Bagian/Bidang</Form.Label>
