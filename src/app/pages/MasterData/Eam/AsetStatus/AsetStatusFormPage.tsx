...
import {
  // IAsetStatus,
  AsetStatusField,
} from "@app/interface/master-data/eam-aset-status.interface";
...
export default function AsetStatusFormPage() {
        ...
        <Col md="6" xs="12">
          <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
            <Form.Group className="mb-3">
              <Form.Label>Nama Status</Form.Label>
