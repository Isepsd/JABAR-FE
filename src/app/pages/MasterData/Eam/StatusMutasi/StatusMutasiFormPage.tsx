...
import {
  // IStatusMutasi,
  StatusMutasiField,
} from "@app/interface/master-data/eam-status-mutasi.interface";
...
export default function StatusMutasiFormPage() {
  ...
  return (
    <>
      <FormData
        ...
        fields={StatusMutasiField}
        path={API_PATH().master.eam.eam_ref_status_mutasi}
        onLoading={setLoading}
      >
        <Col md="6" xs="12">
          <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
            <Form.Group className="mb-3">
              <Form.Label>Status Mutasi</Form.Label>
