...
import {
  // IAsetRuangan,
  AsetRuanganField,
} from "@app/interface/master-data/eam-aset-ruangan.interface";
...
export default function AsetRuanganFormPage() {
  ...
  return (
    <>
      <FormData
        ...
        fields={AsetRuanganField}
        path={API_PATH().master.eam.eam_ref_aset_ruangan}
