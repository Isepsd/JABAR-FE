...
function AsetFormPage() {
  ...
  // const watchKategoriAset = useWatch({ control, name: "id_ref_aset_kategori" });
  ...
  // useEffect(() => {
  //   if (watchKategoriAset) getAdditionalField();
  // }, [watchKategoriAset]);
  ...
  //       sort_by: "nama",
  //       sort_type: "asc",
  //       id_ref_aset_jenis: watchKategoriAset,
  //     };
  ...
  //           data.filter(
  //             (y: any) => x.id_ref_aset_ex_atr == y.id_ref_aset_ex_atr
  //           )
  //         );
  ...
  const upsertData = async (params: any) => {
    ...
    try {
      ...
      //   .map((x: any) => ({
      //     id_ref_aset_ex_atr: x.id_ref_aset_ex_atr,
                            ...
                            <SelectAsyncDynamic
                              ...
                              queryParams={{
                                id_ref_jenis_lokasi_in: `${
                                  JENIS_LOKASI().uid
                                },${JENIS_LOKASI().up3},${JENIS_LOKASI().ulp}`,
                                status_listrik: 1,
                              }}
                            />
                          </Form.Group>
