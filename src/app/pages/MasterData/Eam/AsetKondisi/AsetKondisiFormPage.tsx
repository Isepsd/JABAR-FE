...
import {
  // IAsetKondisi,
  AsetKondisiField,
} from "@app/interface/master-data/eam-aset-kondisi.interface";
...
export default function AsetKondisiFormPage() {
  ...
  return (
    <>
      <FormData
        ...
        fields={AsetKondisiField}
        path={API_PATH().master.eam.eam_ref_aset_kondisi}
        onLoading={setLoading}
      >
        <Col md="6" xs="12">
          <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
            <Form.Group className="mb-3">
              <Form.Label>Nama Kondisi</Form.Label>
