...
import {
  // IAsetLantai,
  AsetLantaiField,
} from "@app/interface/master-data/eam-aset-lantai.interface";
...
export default function AsetLantaiFormPage() {
  ...
  return (
    <>
      <FormData
        ...
        fields={AsetLantaiField}
        path={API_PATH().master.eam.eam_ref_aset_lantai}
        onLoading={setLoading}
      >
        <Col md="6" xs="12">
          <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
            <Form.Group className="mb-3">
              <Form.Label>Nama Lantai</Form.Label>
