...
export default function DaftarPointTidakAPKT(
  ...
  let roleAccess = ROLE_ACCESS("daftar-penyulangzonesegment-tidak-kirim-apkt");
  const roleActions = {
        ...
        <Col md={7}>
          <CardWidget>
            <Row className="gx-3">
              ...
              <Col md={9}>
                <CardWidget title="Daftar Penyulang Tidak Kirim APKT">
                  {/* {roleActions.create && ( */}
                  <TableDataJqxGridNew
                    dataFieldsColsConfig={DAFTAR_PENYULANG_TIDAK_KIRIM_APKT()}
                    respDataApi={handleRespDataApi}
