...
import TableDataJqxGridNewTree from '@app/modules/Table/TableJqxTreeGrid';
...
export default function KinEstimatorStateDetail1({ roleActions, filterParams, path, isUpdateNyala = true }: ITreeJaringan) {
  ...
  const hierarchy = {
    keyDataField: 'id_apkt_trans_jar_det', // Primary key field
    parentDataField: 'id_parent_lokasi', // Field that defines the parent
};
        ...
        >
          ...
          <div key="2">
            ...
            <TableDataJqxGridNewTree
              ...
              // dataSources={handleRespDataApi1}
